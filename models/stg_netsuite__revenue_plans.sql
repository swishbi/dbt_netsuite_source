...
renamed as (
    select
        ...
        {{ adapter.quote("amountsource") }} as amount_source_id, -- revRecAmountSourceType
        ...
        {{ adapter.quote("creationtriggeredbydisplay") }} as revenue_plan_source_id, -- revenuePlanSource
        {{ adapter.quote("iseliminate") }} as is_eliminate,
        {{ adapter.quote("revrecenddate") }} as rev_rec_end_date,
        {{ adapter.quote("enddatechangeimpactfordisplay") }} as end_date_change_impact_id, -- revRecChangeImpactType
        ...
        {{ adapter.quote("item") }} as item_id, -- subscriptionPlan
        ...
        {{ adapter.quote("recognitionmethod") }} as recognition_method_id, -- revRecRecurrenceType
        {{ adapter.quote("recognitionperiod") }} as recognition_period,
        {{ adapter.quote("reforecastmethod") }} as reforecast_method_id, -- reforecastMethod
        ...
        {{ adapter.quote("revrecenddatesource") }} as rev_rec_end_date_source_id, -- revRecDateSourceType
        {{ adapter.quote("revenuerecognitionrule") }} as revenue_recognition_rule_id,
        {{ adapter.quote("revrecstartdatesource") }} as rev_rec_start_date_source_id, -- revRecDateSourceType
